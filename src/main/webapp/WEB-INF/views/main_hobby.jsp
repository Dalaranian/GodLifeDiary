			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach items="${challenges}" var="challenge">
						<c:if test="${challenge.challengeCategory eq '취미' && challenge.challengeEnabled eq 'Y'}">
							<li class="item">
								<div class="cont">
	...
	<div class="sec-main">
		...
		<ul class="each-category">
			<c:choose>
				...
				<c:otherwise>
					<c:forEach items="${challenges}" var="challenge">
						<c:if test="${challenge.challengeCategory eq '취미' && challenge.challengeEnabled eq 'N'}">
							<li class="item">
								<div class="cont">
									<strong id="c_name">${challenge.challengeName }</strong>
									<p id="c_info">${challenge.challengeInfo }</p>
