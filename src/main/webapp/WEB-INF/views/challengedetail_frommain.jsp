		...
		<div class="left_part">
			<div class="left_first">
				<div class="challenge_dscr">
					...
					<fmt:parseNumber
						value="${challenge.challengeStartedDate.time / (1000*60*60*24)}"
					...
					<fmt:parseNumber var="percent" value="${percentage}"
						integerOnly="true" />
					...
					<table>
						<c:forEach var="date" begin="0" end="${duration*7-1}">
							<c:if test="${date % 7 eq 0}">
								<tr>
									<th><fmt:parseNumber value="${date / 7 + 1}"
											integerOnly="true" />주차</th>
							</c:if>
							<td id="did"><div class="date-tooltip"
									data-tooltip="${startDate } "
									onclick="goToCommentDate(${challenge.seq}, ${user.id}, '${startDate}')"></div></td>
